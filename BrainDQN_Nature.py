...
class BrainDQN:
	...
	def createQNetwork(self):
		...
		W_conv3 = self.weight_variable([3, 3, 32, 32])
		b_conv3 = self.bias_variable([32])

		W_fc1 = self.weight_variable([IMAGE_FLAG_SIZE, 512])
		...
		h_conv3_flat = tf.reshape(h_conv3, [-1, IMAGE_FLAG_SIZE])
